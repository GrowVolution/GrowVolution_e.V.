...
1. When applying for membership, the following data are collected:
   ...
   The use of WhatsApp serves as a transitional solution until an association-owned communication infrastructure is provided.
...
2. For the processing of contributions, the following data are collected:
   ...
   - for donations exceeding an amount of 300 € or at the explicit request of the contributing person for the issuance of a donation receipt (Art. 6(1)(c) GDPR),
...
1. The processing of personal data in the context of online and other external presences of the association is governed by a separate privacy policy. The data collected there are processed in accordance with the provisions of that privacy policy.
   ...
   Insofar as such a privacy policy regulates specific processing activities, its provisions take precedence over the provisions of this order. For all processing of personal data not covered by a separate privacy policy, the provisions of this order apply subordinately. Otherwise, such processing constitutes unlawful processing of personal data.

   Privacy policies used by the association may be based in part on and/or supplement this order.

2. Where personal data are processed by external service providers on behalf of the association, this is carried out on the basis of a data processing agreement in accordance with Art. 28 GDPR. In this case, the association remains the controller within the meaning of the GDPR, while the respective service provider acts as a processor.

   Where personal data are processed by the association on behalf of an external user on the basis of a usage or service agreement, the association acts as a processor within the meaning of the GDPR. In this case, the external user is the controller for the processing of the personal data.
...
2. Unless otherwise provided by the other provisions of this order regarding specific processing situations, stored personal data are deleted when they are no longer necessary for the purposes for which they were collected or otherwise processed.
