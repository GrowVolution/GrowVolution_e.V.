...
2. The association’s purpose is realized in particular through:
   ...
   - support in financial self-organization, including assistance with debt relief and structuring,
   - development of a growth-oriented, value-driven community without advertising, distraction, or addictive mechanisms,
   - organization of research and support projects in socially, politically, economically, or scientifically relevant fields,
   - support for the development, production, and dissemination of sustainable, health-promoting, and socially responsible products,
   - promotion of local, resource-efficient, and circular infrastructures,
   - support for community-oriented professional activities and people in underserved professions,
   - preparation and support of organizational forms such as gGmbHs for the charitable implementation of production and distribution structures,
...
3. The voting period is generally 14 days.
