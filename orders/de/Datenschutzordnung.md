...
1. Beim Beantragen einer Mitgliedschaft erheben wir folgende Daten:
   ...
   Die Nutzung von WhatsApp erfolgt als Übergangslösung bis zur Bereitstellung einer vereinseigenen Kommunikationsinfrastruktur.
...
2. Zur Verarbeitung von Zuwendungen erheben wir folgende Daten:
   ...
   - bei Spenden mit einem Betrag von mehr als 300 € oder auf ausdrücklichen Wunsch der zuwendenden Person zur Ausstellung einer Zuwendungsbestätigung (Art. 6 Abs. 1 lit. c DSGVO),
...
1. Die Verarbeitung personenbezogener Daten im Rahmen von Online- und sonstigen externen Auftritten des Vereins wird in einer gesonderten Datenschutzerklärung geregelt. Die dort erhobenen Daten werden entsprechend den Regelungen dieser Datenschutzerklärung verarbeitet.
   ...
   Soweit eine solche Datenschutzerklärung spezielle Verarbeitungen regelt, gehen deren Bestimmungen den Regelungen dieser Ordnung vor. Für alle Verarbeitungen personenbezogener Daten, die nicht durch eine gesonderte Datenschutzerklärung abgedeckt sind, gelten nachrangig die Regelungen dieser Ordnung. Andernfalls handelt es sich um eine unzulässige Verarbeitung personenbezogener Daten.

   Vom Verein verwendete Datenschutzerklärungen können sich in Teilen und/oder ergänzend auf diese Ordnung stützen.
...
2. Ist nicht auszuschließen, dass der Verein im Kontext eines von ihm bereitgestellten Angebots an besondere Kategorien personenbezogener Daten gelangt, dann darf eine Verarbeitung gemäß Art. 9 Abs. 2 lit. a DSGVO nur erfolgen, sofern die betroffene Person zuvor eine ausdrückliche, informierte und jederzeit widerrufbare Einwilligung erteilt hat.

3. Alle im Rahmen der Vereinsarbeit bekanntwerdenden personenbezogenen Daten werden vom Verein vertraulich und zweckgebunden behandelt.

   Eine Speicherung oder Weitergabe erfolgt nur, soweit dies zur Erfüllung der satzungsgemäßen Zwecke, zur Wahrung berechtigter Interessen, zur Erfüllung rechtlicher Verpflichtungen oder zum Schutz der betroffenen Person oder der Öffentlichkeit erforderlich ist.
...
1. Die Dauer der Speicherung von personenbezogenen Daten bemisst sich anhand der jeweiligen Rechtsgrundlage, am Verwendungszweck und – sofern einschlägig – zusätzlich anhand der jeweiligen gesetzlichen Aufbewahrungsfrist.
   ...
   Existieren gesetzliche Aufbewahrungsfristen für Daten, die im Rahmen rechtsgeschäftlicher bzw. rechtsgeschäftsähnlicher Verpflichtungen auf der Grundlage von Art. 6 Abs. 1 lit. b DSGVO verarbeitet werden, werden diese Daten nach Ablauf der Aufbewahrungsfristen routinemäßig gelöscht, sofern sie nicht mehr zur Vertragserfüllung oder Vertragsanbahnung erforderlich sind und/oder seitens des Vereins kein berechtigtes Interesse an der Weiterspeicherung fortbesteht.

2. Sofern sich aus den sonstigen Regelungen dieser Ordnung über spezifische Verarbeitungssituationen nichts anderes ergibt, werden gespeicherte personenbezogene Daten dann gelöscht, wenn sie für die Zwecke, für die sie erhoben oder auf sonstige Weise verarbeitet wurden, nicht mehr notwendig sind.